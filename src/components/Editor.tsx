...
import { analyticsForNode, edgeLabel, nodePosition } from '../model/funnel'
...
function EditorCanvas({ document, onBack, onAnalytics, onWorkspace, onSave, onPublished }: EditorProps) {
